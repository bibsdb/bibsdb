...
<article class="news">
  ...
  <h1 class="page-title">
    ...
    <?php if (empty($content['field_ding_news_title_image']) || isset($content['field_bibsdb_fact_box_title']) || isset($content['field_bibsdb_fact_box_body'])) : ?>
    <div class="news-right-col">
    ...
    <?php if (isset($content['field_bibsdb_fact_box_title']) || isset($content['field_bibsdb_fact_box_body'])) : ?>
      <div class="bibsdb-fact-box">
        <?php if (isset($content['field_bibsdb_fact_box_title'])) : ?>
          <h2>
            <?php print render($content['field_bibsdb_fact_box_title']); ?>
          </h2> 
        <?php endif; ?>
        <?php if (isset($content['field_bibsdb_fact_box_body'])) : ?>
          <div>
            <?php print render($content['field_bibsdb_fact_box_body']); ?>
          </div> 
        <?php endif; ?>
      </div>
    <?php endif; ?>
  ...
  <?php endif; ?>
    ...
    <div class="news-content">
      ...
      hide($content['field_bibsdb_tag']);
      hide($content['ding_news_groups_ref']);
      hide($content['field_bpi_workflow']);
