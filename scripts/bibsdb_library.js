(function($) {
	 ...
	 */
	 function highlight_sonderborg_on_library_list() {
	 	...
	 	var msg = $('<div>').css('color', 'red').text("Vi åbner igen d. 4. november i Multikulturhuset, Nørre Havnegade 15");
	 ...
	 */
	 function highlight_sonderborg_on_library_page() {
	 	...
	 	var msg = $('<p>').css('color', 'red').text("Biblioteket Sønderborg er lukket pga. af flytning. Vi åbner igen d. 4. november i Multikulturhuset, Nørre Havnegade 15");
